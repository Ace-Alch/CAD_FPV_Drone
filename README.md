...
&nbsp; <img src="Docs/Assembly\_Explode.gif" width="80%" alt="Exploded Drone Assembly">
...
> See full breakdown in \[`Docs/Assembly\_Explode3D.pdf`](Docs/Assembly\_Explode3D.pdf)
...
\-  \[`Assembly\_Explode3D.pdf`](Docs/Assembly\_Explode3D.pdf): Exploded 3D view with part list  

\-  \[`Assembly\_Draw3D.pdf`](Docs/Assembly\_Draw3D.pdf): Standard 3D drawing with multiple projections  

\-  SolidWorks source files (`\*.SLDPRT`, `\*.SLDASM`)

\-  Animated exploded view: `Assembly\_Explode.gif`
...
\- \[ ] Integrate with flight controller I have done, from \[HERE](https://github.com/Ace-Alch/dji-mavic-sim)
